...
//작성한 데이터가 브라우저에 어떻게 표시되는지를 확인하는 용도로 쓰인다.
//console.log("test");

// 1. var 변수 선언과 호이스팅
// - 2015년 이후에 const와 let으로 대체된 변수 선언 키워드
...
// - let으로 선언된 변수의 값의 변경은 가능하지만, 선언을 다시 할 수 없다.
//console.log(letVar);
letletVar = "let variable";
console.log(letVar);

letletVar = "let variable";
console.log(letVar);

// let Var="again  let variable again";
