...
// - 함수의 이름 식별자는 (대개) 동사 형태로 작성한다 : ex) eventListener, startSlide...
...
overParams(3, 5, 7); //3,5,7

// - 반대로 선언된 매개변수가 더 많을 경우 마지막 매개변수는 무시된다

overParams(3, 5, 7, 9); //3,5,7
...
// - 그 외 화살표 함수는 일반 함수 작성 방식보다 간편하고, 최근 트렌드에 맞춰가기 위해 사용하는 것이 일반적이다. 필수 사용은 아니다.
